...
function edit_content(category_name,card_name,card_content,category_row_id)
{
  ...
  current_card_name.innerHTML=(
    '<form action="category_content.php?"  method="get" id="edit_form">'+
      "<textarea cols='59' id="+'"'+current_name_textarea_id+'"'+" onkeyup='adjustheight(this)' form='edit_form'       name='edit_name_textarea'>"+card_name+
      "</textarea>"+
  ...
  current_card_content.innerHTML=(
    '<form action="category_content.php?"  method="get" id="edit_form">'+
      "<textarea cols='59' id="+'"'+current_content_textarea_id+'"'+" onkeyup='adjustheight(this)' form='edit_form'       name='edit_content_textarea' style='height:"+$predicted_current_card_content_height+"px'>"+card_content+
      "</textarea>"+
